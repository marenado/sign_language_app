...
import { Box, Card, Typography, Button, Modal, TextField, Select, MenuItem } from '@mui/material';
...
const TaskList = () => {
  ...
  const handleTaskTypeChange = (type) => {
    setTaskData((prev) => ({
      ...
      points: type === 'sign_presentation' ? 0 : prev.points,
    }));
  };
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setTaskData((prev) => ({
                        ...
                        correct_answer:
                          prev.correct_answer?.option === option ? {} : prev.correct_answer,
                      }))
                    }
                    sx={{
                      padding: '8px 16px',
        ...
        return (
          <>
            ...
            <Button
              ...
              disabled={!newPair.word || !newPair.video}
            >
              Add Pair
            </Button>
            ...
            <Box sx={{ marginBottom: '15px' }}>
              {(taskData.content.options || []).map((option, index) => (
                ...
                >
                  ...
                  />
                  <Button
                    variant={taskData.correct_answer?.option === option ? 'contained' : 'outlined'}
                    color="success"
                    onClick={() =>
                      setTaskData((prev) => ({
                        ...prev,
                  ...
                  >
                    {taskData.correct_answer?.option === option ? 'Correct' : 'Set Correct'}
                  </Button>
                  <Button
                    variant="outlined"
                    color="error"
                    onClick={() =>
                      setTaskData((prev) => ({
                        ...
                        correct_answer:
                          prev.correct_answer?.option === option ? null : prev.correct_answer,
                      }))
                    }
                    sx={{
                      padding: '8px 16px',
